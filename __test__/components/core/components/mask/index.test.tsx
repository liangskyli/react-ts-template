...
vi.mock('@/components/core/utils/use-lock-scroll.ts', () => {
  return {
    useLockScroll: () => vi.fn(),
  };
});

vi.mock('@/components/core/utils/render-to-container', () => {
  return {
...
describe('Mask Component', () => {
  ...
  it('should use correct useLockScroll parameters', async () => {
    const useLockScrollSpy = vi.spyOn(
      await import('@/components/core/utils/use-lock-scroll.ts'),
      'useLockScroll',
    );
  ...
  it('should use renderToContainer with correct parameters', async () => {
    const renderToContainerSpy = vi.spyOn(
      await import('@/components/core/utils/render-to-container.ts'),
      'renderToContainer',
    );
