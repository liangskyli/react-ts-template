...
const StepsDemo = () => {
  ...
  const customIconItems: StepItem[] = [
    {
      ...
      description: '用户登录',
      icon: (
        <svg className="tw-h-4 tw-w-4" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
  ...
  return (
    <div className="tw-space-y-8 p-4">
      ...
      <section className="tw-space-y-4">
        ...
        <div className="tw-rounded-lg tw-border tw-bg-white tw-p-6">
          ...
          <div className="tw-mt-6 tw-space-x-2">
            <button
      ...
      <section className="tw-space-y-4">
        ...
        <div className="tw-rounded-lg tw-border tw-bg-white tw-p-6">
          <div className="tw-flex">
            ...
            <div className="tw-ml-8 tw-space-y-2">
              <button
                className="tw-block tw-rounded tw-bg-blue-500 tw-px-4 tw-py-2 tw-text-white hover:tw-bg-blue-600"
                onClick={() =>
      ...
      <section className="tw-space-y-4">
        ...
        <div className="tw-rounded-lg tw-border tw-bg-white tw-p-6">
          <Steps
            ...
            onChange={setCurrent}
          />
          <p className="tw-mt-4 tw-text-gray-600">点击步骤可以直接跳转</p>
        </div>
      </section>
      ...
      <section className="tw-space-y-4">
        ...
        <div className="tw-rounded-lg tw-border tw-bg-white tw-p-6">
          ...
          />
          <p className="tw-mt-4 tw-text-gray-600">第三步被禁用，无法点击</p>
        </div>
      </section>
